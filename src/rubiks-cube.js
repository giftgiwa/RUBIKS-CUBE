...
class RubiksCube {
     ...
     */
    counterclockwiseOuterRotationMap = {
        W: ["B", "O", "G", "R"],
        B: ["W", "R", "Y", "O"],
        O: ["W", "B", "Y", "G"],
        G: ["W", "O", "Y", "R"],
    ...
    getMovesAndRotationGroups() {
        /**
         * Add additional rotation group keys (for middle layer pieces
         * in cubes bigger than 2x2)
         */
        let middleLayerKeys = ["W#Y", "B#G", "R#O"];
        for (let i = 1; i <= this.dimension - 2; i++) {
            for (let j = 0; j < middleLayerKeys.length; j++)
                this.rotationGroups[`${middleLayerKeys[j]}${i}`] = [];
        }
        ...
        for (const [key, _] of Object.entries(this.rotationGroups)) {
            if (key.length == 1) {
                ...
                // middle wedges (for cubes largeer than 2x2)
                this.moves.push(`${key}|cw`);
                this.moves.push(`${key}|ccw`);
            }
        }
    ...
    initCoordinateMap() {
        ...
        for (let i = 0; i < this.mesh.children.length; i++) {
            ...
            if (this.solvedStateOrientations[x][y][z] != null) {
                ...
                let currentOrientationMap =
                    this.solvedStateOrientations[x][y][z];
                    ...
                    if (this.coordinateMap[i][j][k]) {
                        if (i == 0) {
                            this.rotationGroups["W"].push(
                                this.coordinateMap[i][j][k],
                            ); // white
                            this.coordinateMap[i][j][k].rotationGroups.push(
                                "W",
                            );
                        }
                        ...
                        if (i > 0 && i < this.dimension - 1) {
                            this.rotationGroups[`W#Y${i}`].push(
                                this.coordinateMap[i][j][k],
                            ); // white/yellow
                            this.coordinateMap[i][j][k].rotationGroups.push(
                                `W#Y${i}`,
                        ...
                        if (j > 0 && j < this.dimension - 1) {
                            this.rotationGroups[`B#G${j}`].push(
                                this.coordinateMap[i][j][k],
                            ); // blue/green
                            this.coordinateMap[i][j][k].rotationGroups.push(
                                `B#G${j}`,
                        ...
                        if (k > 0 && k < this.dimension - 1) {
                            this.rotationGroups[`R#O${k}`].push(
                                this.coordinateMap[i][j][k],
                            ); // blue/green
                            this.coordinateMap[i][j][k].rotationGroups.push(
                                `R#O${k}`,
    ...
    createMiddleLayerRotationMaps() {
        for (let i = 1; i <= this.dimension - 2; i++) {
            // inner to inner
            this.counterclockwiseInnerToInnerRotationMap[`B#G${i}`] = [
                `R#O${i}`,
                `W#Y${this.dimension - i - 1}`,
                `R#O${this.dimension - i - 1}`,
                `W#Y${i}`,
            ];
            this.clockwiseInnerToInnerRotationMap[`B#G${i}`] = [
                `R#O${i}`,
                `W#Y${i}`,
                `R#O${this.dimension - i - 1}`,
                `W#Y${this.dimension - i - 1}`,
            ];
            this.clockwiseInnerToInnerRotationMap[`R#O${i}`] = [
                `B#G${i}`,
                `W#Y${this.dimension - i - 1}`,
                `B#G${this.dimension - i - 1}`,
                `W#Y${i}`,
            ];
            this.counterclockwiseInnerToInnerRotationMap[`R#O${i}`] = [
                `B#G${i}`,
                `W#Y${i}`,
                `B#G${this.dimension - i - 1}`,
                `W#Y${this.dimension - i - 1}`,
            ];
            this.counterclockwiseInnerToInnerRotationMap[`W#Y${i}`] = [
                `B#G${i}`,
                `R#O${this.dimension - i - 1}`,
                `B#G${this.dimension - i - 1}`,
                `R#O${i}`,
            ];
            this.clockwiseInnerToInnerRotationMap[`W#Y${i}`] = [
                `B#G${i}`,
                `R#O${i}`,
                `B#G${this.dimension - i - 1}`,
                `R#O${this.dimension - i - 1}`,
            ...
            // outer to inner
            this.counterclockwiseOuterToInnerRotationMap[`B${i}`] = [
                `R#O${i}`,
                `W#Y${this.dimension - i - 1}`,
                `R#O${this.dimension - i - 1}`,
                `W#Y${i}`,
            ];
            this.clockwiseOuterToInnerRotationMap[`B${i}`] = [
                `R#O${i}`,
                `W#Y${i}`,
                `R#O${this.dimension - i - 1}`,
                `W#Y${this.dimension - i - 1}`,
            ];
            this.clockwiseOuterToInnerRotationMap[`G${i}`] = [
                `R#O${i}`,
                `W#Y${this.dimension - i - 1}`,
                `R#O${this.dimension - i - 1}`,
                `W#Y${i}`,
            ];
            this.counterclockwiseOuterToInnerRotationMap[`G${i}`] = [
                `R#O${i}`,
                `W#Y${i}`,
                `R#O${this.dimension - i - 1}`,
                `W#Y${this.dimension - i - 1}`,
            ];
            this.clockwiseOuterToInnerRotationMap[`R${i}`] = [
                `B#G${i}`,
                `W#Y${this.dimension - i - 1}`,
                `B#G${this.dimension - i - 1}`,
                `W#Y${i}`,
            ];
            this.counterclockwiseOuterToInnerRotationMap[`R${i}`] = [
                `B#G${i}`,
                `W#Y${i}`,
                `B#G${this.dimension - i - 1}`,
                `W#Y${this.dimension - i - 1}`,
            ];
            this.counterclockwiseOuterToInnerRotationMap[`O${i}`] = [
                `B#G${i}`,
                `W#Y${this.dimension - i - 1}`,
                `B#G${this.dimension - i - 1}`,
                `W#Y${i}`,
            ];
            this.clockwiseOuterToInnerRotationMap[`O${i}`] = [
                `B#G${i}`,
                `W#Y${i}`,
                `B#G${this.dimension - i - 1}`,
                `W#Y${this.dimension - i - 1}`,
            ];
            this.counterclockwiseOuterToInnerRotationMap[`W${i}`] = [
                `B#G${i}`,
                `R#O${this.dimension - i - 1}`,
                `B#G${this.dimension - i - 1}`,
                `R#O${i}`,
            ];
            this.clockwiseOuterToInnerRotationMap[`W${i}`] = [
                `B#G${i}`,
                `R#O${i}`,
                `B#G${this.dimension - i - 1}`,
                `R#O${this.dimension - i - 1}`,
            ];
            this.clockwiseOuterToInnerRotationMap[`Y${i}`] = [
                `B#G${i}`,
                `R#O${this.dimension - i - 1}`,
                `B#G${this.dimension - i - 1}`,
                `R#O${i}`,
            ];
            this.counterclockwiseOuterToInnerRotationMap[`Y${i}`] = [
                `B#G${i}`,
                `R#O${i}`,
                `B#G${this.dimension - i - 1}`,
                `R#O${this.dimension - i - 1}`,
    ...
    generateSolvedState() {
        ...
        if (this.dimension > 3) {
            for (let i = 0; i < this.solvedStateOrientations.length; i++) {
                for (
                    let j = 0;
                    j < this.solvedStateOrientations[i].length;
                    j++
                ) {
                    for (let c = 1; c <= this.dimension - 3; c++) {
                        ...
                        Object.assign(
                            orientationCopy,
                            this.solvedStateOrientations[i][j][1],
                        );
                        this.solvedStateOrientations[i][j].insert(
                            1,
                            orientationCopy,
                        );
                    }
                ...
                for (let c = 1; c <= this.dimension - 3; c++) {
                    this.solvedStateOrientations[i].insert(
                        1,
                        JSON.parse(
                            JSON.stringify(this.solvedStateOrientations[i][1]),
                        ),
                    );
                }
            }
            for (let c = 1; c <= this.dimension - 3; c++)
                this.solvedStateOrientations.insert(
                    1,
                    JSON.parse(JSON.stringify(this.solvedStateOrientations[1])),
                );
    ...
    updateCoordinateHashmap() {
        ...
        for (const [key, value] of Object.entries(this.rotationGroups)) {
            for (let i = 0; i < value.length; i++) {
                this.coordinateHashmap[
                    `${value[i].coordinates[0]}${value[i].coordinates[1]}${value[i].coordinates[2]}`
                ] = value[i];
            }
        }
    }
