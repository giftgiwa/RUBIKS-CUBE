 ...
 */
if (!window.mobileCheck()) renderer.setPixelRatio(window.devicePixelRatio * 2);
...
function animate() {
     ...
     */
    if (!mouseDown) {
        if (intersects.length > 0) trackballControls.enabled = false;
        else trackballControls.enabled = true;
    }
